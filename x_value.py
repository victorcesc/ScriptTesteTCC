...
media = 0
# Gerar um número aleatório seguindo uma distribuição normal
variavel_gaussiana = np.random.normal(media, sigma)

# Imprimir o valor da variável gaussiana
print(variavel_gaussiana)
